...
Metadata Management: Catalog titles, authors, and publication dates in a structured format.
Search Optimization: Enable fast retrieval of documents through an indexed database.
## Getting Started
### PrerequisitesPython 3.9+Pip (Python package manager)Git
### InstallationClone the Repository:Bashgit clone https://github.com/HemanthMadhusudhan/HashEbooks.git
cd HashEbooks
...
### Core CommandsCommandDescription
--scanScans a directory for new eBook files.
